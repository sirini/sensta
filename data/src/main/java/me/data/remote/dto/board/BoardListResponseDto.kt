...
import me.domain.model.board.NuboBoardListResponse
import me.domain.model.board.NuboBoardListResult
...
fun BoardListResponseDto.toEntity() = NuboBoardListResponse(
    success = success,
    error = error,
    code = code,
...
fun BoardListResultDto.toEntity() = NuboBoardListResult(
