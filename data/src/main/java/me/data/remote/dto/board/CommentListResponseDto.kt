...
import me.domain.model.board.NuboCommentListResponse
import me.domain.model.board.NuboCommentListResult
...
fun CommentListResponseDto.toEntity() = NuboCommentListResponse(
    success = success,
    error = error,
    code = code,
...
// 댓글 목록 Result 엔티티
fun CommentListResultDto.toEntity() = NuboCommentListResult(
    boardUid = boardUid,
    sinceUid = sinceUid,
