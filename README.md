...
현재 개발 버전은 **2.1.1**(`versionCode 24`)이며 Android 8(API 26) 이상을 지원합니다. Android 17
...
- 사진을 빠르게 훑어보는 탐색 그리드
- 최근 작품 헤더, 접히는 프로필, 사진·메시지 탭으로 구성한 사진가 페이지
- 프로필의 누적 작품·사진·조회·좋아요·댓글과 작품별 성과·정렬을 보여주는 내 작품 스튜디오
